(function (h) {
    ...
    g.ext.buttons.importFlash = h.extend({}, t, {
        className: "buttons-import buttons-flash",
        text: function (a) {
            return a.i18n("buttons.import", "import");
        },
        ...
        action: function (a, b, d, c) {
            ...
            var a = c._flash,
                ...
                d = {
                    ...
                    xl: { _rels: { "workbook.xml.rels": h.parseXML(m["xl/_rels/workbook.xml.rels"]) }, "workbook.xml": h.parseXML(m["xl/workbook.xml"]), "styles.xml": h.parseXML(m["xl/styles.xml"]), worksheets: { "sheet1.xml": f } },
                        ...
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            ...
                            g ||
                                ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                    ? (g = o(f, "c", { attr: { t: "n", r: d }, children: [o(f, "v", { text: a[b] })] }))
                                    : ((m = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                                      (g = o(f, "c", { attr: { t: "inlineStr", r: d }, children: { row: o(f, "is", { children: { row: o(f, "t", { text: m }) } }) } }))));
                            l.appendChild(g);
                        }
                    }
                    i.appendChild(l);
