(function (j) {
    ...
    m.ext.buttons.copyHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.copy", "Salin");
        },
    ...
    m.ext.buttons.importHtml5 = {
        className: "buttons-import buttons-html5",
        text: function (a) {
            return a.i18n("buttons.import", "Salin");
        },
        ...
        action: function (a, c, d, b) {
            ...
            var e = this,
                ...
                a = {
                    ...
                    xl: { _rels: { "workbook.xml.rels": a("xl/_rels/workbook.xml.rels") }, "workbook.xml": a("xl/workbook.xml"), "styles.xml": a("xl/styles.xml"), worksheets: { "sheet1.xml": g } },
                        ...
                        if (!(null === a[b] || a[b] === q || "" === a[b])) {
                            ...
                            e ||
                                ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                    ? (e = p(g, "c", { attr: { t: "n", r: d }, children: [p(g, "v", { text: a[b] })] }))
                                    : ((m = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                                      (e = p(g, "c", { attr: { t: "inlineStr", r: d }, children: { row: p(g, "is", { children: { row: p(g, "t", { text: m }) } }) } }))));
                            l.appendChild(e);
                        }
                    }
                    n.appendChild(l);
